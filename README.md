<div align="center">
  ...
  <p align="center">
    Пример запуска приложения Flask на платформе Dockhost
    <br />
...
## О Dockhost и примере приложения Flask

Dockhost - это бессерверная платформа для развёртывания приложений на основе Docker-контейнеров.

Этот пример приложения предназначен для демонстрации того, как приложение Flask может быть развёрнуто на Dockhost при помощи Push-to-Deploy.
...
Выполните одно из следующих действий, чтобы развернуть и запустить приложение Flask на Dockhost.
...
3. В открывшемся модальном окне укажите адрес: https://raw.githubusercontent.com/dockhost/example-flask/main/dockhost.yaml
...
```shell
dockhost compose apply https://raw.githubusercontent.com/dockhost/example-flask/main/dockhost.yaml
```
...
4. Введите название, например «flask», и нажмите на кнопку «Применить».
...
отправить [pull request](https://github.com/dockhost/example-flask/pulls).